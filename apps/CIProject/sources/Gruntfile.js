// Generated on 2014-08-17 using generator-ionic 0.4.1
'use strict';
  ...
  grunt.initConfig({
    ...
    'bower-install': {
      app: {
        ...
        exclude: [
            '<%= yeoman.app %>/bower_components/ionic/release/css'
        ]
      }
    },
    ...
    usemin: {
      html: ['<%= yeoman.dir %>/**/*.html'],
      css: ['<%= yeoman.dir %>/<%= yeoman.styles %>/**/*.css'],
      options: {
        assetsDirs: ['www']
      }
    },
    ...
    //   dist: {
    //     files: {
    //       '<%= yeoman.dir %>/<%= yeoman.styles %>/main.css': [
    //         '.tmp/<%= yeoman.styles %>/**/*.css',
    ...
    //   dist: {
    //     files: {
    //       '<%= yeoman.dir %>/<%= yeoman.scripts %>/scripts.js': [
    //         '<%= yeoman.dir %>/<%= yeoman.scripts %>/scripts.js'
    //       ]
    //     }
    //   }
