...
/**
 @ingroup hybrid main
 An enumeration of Worklight web framework initalization status codes.
 */
typedef enum {
 ...
 * @ingroup hybrid main
 *
 * The result object containing information about the Worklight web framework initialization status.
 *.
 */
...
//properties
/**
 @property statusCode The Worklight web framework initalization status code.
 
 */
@property (nonatomic, assign, readonly) StatusCode statusCode;

/** @property message
 *  The Worklight web framework initalization message.
 **/
